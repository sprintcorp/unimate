...
//  User route
    Route::group(['prefix' => 'user','middleware'=>'auth:api'], function(){
        ...
        Route::post('/add-user-to-group/{id}',[GroupController::class,'addUserToGroup'])->name('addUserToGroup');
        Route::delete('/remove-user-from-group/{id}',[GroupController::class,'removeUserFromGroup'])->name('removeUserFromGroup');
